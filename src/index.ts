...
const logger = ((window as any).G7Core?.createLogger?.('Template:glitter-academy_core')) ?? {
    log: (...args: unknown[]) => console.log('[Template:glitter-academy_core]', ...args),
    warn: (...args: unknown[]) => console.warn('[Template:glitter-academy_core]', ...args),
    error: (...args: unknown[]) => console.error('[Template:glitter-academy_core]', ...args),
};
